...
const jobSchema = new mongoose.Schema({
    title:{
        type:String,
        required:[true,"Please provide job titile"],
    ...
    description:{
        ...
        minLength:[3,"Job description must be contain at least 50 characters!"],
    ...
    location: {
        ...
        minLength:[5,"Job location must be contain at least 50 characters!"],
    },
    fixedSalary:{
        type:Number,
